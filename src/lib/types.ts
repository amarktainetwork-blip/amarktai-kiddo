...
export type Settings = { daily_message_limit:number; media_enabled:boolean; memory_enabled:boolean };
export type SessionData = { user:User; children:Child[]; settings?:Settings; ledger?:Array<{amount:number;reason:string;created_at:string}>; parentGateUnlocked?:boolean };
...
export type Capabilities = { configured:boolean; activeProvider:string|null; chat:boolean; story:boolean; image:boolean; music:boolean };
