...
export const api={
  ...
  createChild:(input:{name:string;age:number;avatarChoice:string;language:string;voiceGender:'female'|'male';voiceId:string})=>request<{child:Child}>('/api/children',{method:'POST',body:JSON.stringify(input)}),
