  ...
  return <div className="marketing-shell">
    <header className="marketing-nav">
      <Link className="kiddo-wordmark" to="/" aria-label="Amarktai Kiddo home">
        ...
        <span className="wordmark-tagline">learn · explore · grow · together</span>
      </Link>
      <nav>
      ...
      <div className="marketing-actions">
        <Link className="btn ghost" to="/login">Parent login</Link>
    ...
    <footer className="marketing-footer">
      <div className="footer-brand">
        ...
        <p>Big questions. Brighter tomorrows.</p>
      </div>
