...
export default function MarketingShell({children}:{children:ReactNode}) {
  return <div className="marketing-shell">
    ...
    <footer className="marketing-footer">
      ...
      <div><b>Explore</b><Link to="/how-it-works">How it works</Link><Link to="/creativity">Stories, pictures & music</Link><Link to="/for-parents">For parents</Link><Link to="/safety">Safety</Link></div>
